...
/// <summary>
/// Controls a button the player must press with perfect timing.
/// </summary>
public class MusicButton : MonoBehaviour
{
    private RhythmDemo rhythmDemo;
    private AudioSource audioSource;
    private TextMeshProUGUI clickResult;
    private GameObject newBoundingBox;
    ...
    public void SetRhythmDemo(RhythmDemo newGameplayController)
    {
        ...
        audioSource = rhythmDemo.audioSourceMusic;
    ...
    IEnumerator flashButton()
    {
        ...
        float startTime = rhythmDemo.audioSourceMusic.time;
        ...
        float clipLength = rhythmDemo.audioSourceMusic.clip.length;
        ...
        animDuration = timeUntilPerfect + rhythmDemo.TimeAfter;
        ...
        while(currentAnimDuration < animDuration)
        {
            ...
            float currentUpdate = rhythmDemo.audioSourceMusic.time;
    ...
    public void OnMouseDown()
    {
        ...
        if((!rhythmDemo.OptionClicked) && (!missed))
        {
            ...
            float clickTime = rhythmDemo.audioSourceMusic.time;
            float currentPerfectTime = rhythmDemo.CurrentPerfectTime;
            ...
            if(((currentPerfectTime - rhythmDemo.TimePerfectWindowHalf) <= clickTime) && (clickTime <= (currentPerfectTime + rhythmDemo.TimePerfectWindowHalf)))
            {
    ...
    {
        float clickTime = rhythmDemo.audioSourceMusic.time;
        float duration = rhythmDemo.TimeButtonDrift;
        ...
        while(currentDuration < duration)
        {
            ...
            currentDuration = (rhythmDemo.audioSourceMusic.time - clickTime);
            currentAlpha -= 0.02f;
            yield return null;
        }
